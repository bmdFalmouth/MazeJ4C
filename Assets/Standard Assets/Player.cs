...
public class Player : MonoBehaviour 
{
	...
	{
		int leadScore = (int)GameSettings.leadScore;
		int support1 = (int)GameSettings.support1Score;
		int support2 = (int)GameSettings.support2Score;
		int support3 = (int)GameSettings.support3Score;
